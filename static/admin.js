...
const _CLOUD_MODELS = {
  ...
  fireworks: ["accounts/fireworks/models/qwen3-vl-30b-a3b-instruct", "accounts/fireworks/models/llama-v3p3-70b-instruct"],
  groq:      ['llama-3.3-70b-versatile', 'llama-3.1-8b-instant', 'mixtral-8x7b-32768', 'deepseek-r1-distill-llama-70b'],
};

const _FIELD_OPTIONS = {
  MOTION_VISION_PROVIDER: ['gemini', 'fireworks', 'ollama', 'ollama_remote'],
  LLM_PROVIDER:  ['ollama', 'openai', 'google', 'anthropic', 'groq', 'fireworks'],
